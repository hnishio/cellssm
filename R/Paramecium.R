#' Time-series of Paramecium escape responses
#'
#' @description A simulated dataset containing the time-series of distances of 10 Paramecium
#' from a laser heating.
#'

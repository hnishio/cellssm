...
#'
#' \code{lm_dist_start} performs the linear regression to analyze the
...
#' The default is "cell".
#' @param ex_name (character string) The name of an explanatory variable. This is used for graph labels.
